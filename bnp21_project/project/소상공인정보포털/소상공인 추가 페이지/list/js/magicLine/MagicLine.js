...
// var isMsie = (sUserAgent.toLowerCase().indexOf('msie') >-1) || (sUserAgent.toLowerCase().indexOf('trident') >-1);
var isMsie = (browser.indexOf('msie') >-1) || (browser.indexOf('trident') >-1);
