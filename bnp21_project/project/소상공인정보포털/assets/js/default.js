...
function gnbFnc(){
	...
	topnavs.bind('mouseenter',function(){
		...
		$(this).addClass('on');
		//topnavsUl.stop().animate({"height": 230 + "px","padding-top": 15 + "px"},300);
		topnavsUl.stop().animate({"height": 470 + "px","padding-top": 0 + "px"},300);
	});
	...
	topnavsA.bind('focusin',function(){
		...
		//topnavsUl.stop().css({"height": 230 + "px","padding-top": 15 + "px"},300);
		topnavsUl.stop().css({"height": 470 + "px","padding-top": 0 + "px"},300);
	});
}
