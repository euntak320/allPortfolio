        ...
        <div class="intro_area on">
            <section class="section">
                <div class="slide intro_con01">
                    <div class="txt_box"><p><span class="en_mont">A Better Environment</span></p></div>
                </div>
                <div class="slide intro_con02">
                    <div class="txt_box"><p><span class="en_mont">A Better Nature</span></p></div>
                </div>
                <div class="slide intro_con03">
                    <div class="txt_box"><p><span class="en_mont">A Better Future</span></p></div>
                </div>
                <div class="slide intro_con04">
                    <div class="txt_box"><p><span class="en_mont">The Environmental Company</span></p><p><span class="en_mont">You Can Trust, ECORBIT</span></p></div>
                </div>
