...
function imgInteraction() {
  var $helloImg = $('.hasisipark').find('.img-box');
...
function txtInteraction() {
  var $helloTxt = $('.hasisipark').find('.motion-txt');
...
ScrollTrigger.matchMedia({
  '(min-width: 769px)': function minWidth769px() {
    ...
    window.addEventListener('load', function () {
      gsap.timeline({
        scrollTrigger: {
          trigger: $('.hasisipark__sec-1'),
          start: 'bottom bottom',
          endTrigger: $('.hasisipark__sec-2'),
          end: 'top top',
          scrub: 0,
          pin: true,
          pinSpacing: false,
